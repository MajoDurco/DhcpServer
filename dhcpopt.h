...
void initOptList(optList *);
int lenList(optList *);
void deleteList(optList *);
...
int fillOptions(optList *,dhcp_msg *,int ,uint32_t ,uint32_t );
int createDHCPmsgType(optList *,int );
void convertOptions(optList *, dhcp_msg *);
int createSubnetMask(optList* t,uint32_t);
int createServerIdentifier(optList* t,uint32_t);
int leaseTime(optList* );
